# o-MATIC Studio — ChatGPT Instructions

Load `../../contracts/STUDIO-RUNTIME-CONTRACT.md` and all canonical skills under
`../../skills/`. Connect the o-MATIC Server MCP application.
