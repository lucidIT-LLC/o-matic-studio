<!-- GENERATED COPY — do not edit. Source: studio/adapters/ROLE-CORE.md
...
Load this file with `./STUDIO-RUNTIME-CONTRACT.md` and the canonical
...
9. **Evidence honesty.** No Studio role has a conformance eval that has ever been
   executed. `studio/evals/studio-role-conformance.yaml` in the Studio pack is version 1: five prose
